...
keymap("n", "<leader>.",
  ":w<CR>:if &filetype ==# 'c' || &filetype ==# 'cpp'<CR>:TermExec cmd=\"g++ % -o main && ./main\"<CR>:elseif &filetype ==# 'python'<CR>:TermExec cmd=\"python %\"<CR>:elseif &filetype ==# 'javascript'<CR>:TermExec cmd=\"npm start\"<CR>endif<CR><CR>"
  , opts)
...
-- Cphelper
keymap("n", "<leader>k", ":w<CR>:CphTest<CR>", opts)
